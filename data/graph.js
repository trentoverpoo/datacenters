...
window.__GRAPH__ = {
 ...
 "nodes": [
  ...
  },
  {
   ...
   "summary": "Retired judge, appointed to the case by Judge Baker on 8 September. She issued the show-cause summonses to the County and the three commissioners, returnable at 1:00 p.m. on 21 September 2026. That hearing was held, and the restraining order was extended rather than replaced with a preliminary injunction.",
   "caveat": "The report of the 21 September hearing does not name the judge who heard it. The summonses she signed and the docket entry both set it before her; no document in this file records who took the bench.",
   "aliases": [
    "Cook",
    "Jackie Cook"
   ],
   ...
   "citations": [
    {
     "doc": "evidence/04-litigation/26BE-CC00056_nsi-6-v-benton-county/press/2026-09-21_ky3-com_judge-extends-restraining-order-benton-county-data-center-case.pdf",
     "url": "https://www.ky3.com/2026/09/21/judge-extends-restraining-order-benton-county-mo-data-center-case/",
     "label": "KY3 · the show-cause hearing and its outcome",
     "date": "2026-09-21",
 ...
 "edges": [
  ...
  },
  {
   ...
   "targetId": "case-nsi6-v-benton",
   "type": "legal",
   "label": "appointed 8 September 2026 · extended the restraining order on 21 September",
   "because": null,
   "tier": 1,
   "projects": [
    "benton"
